                    ...
                    <div class="bottom_part">
                        ...
                        <div class="lower_half">
                            <div class="like">
                                ...
                                <a href="#" onclick="document.getElementById('like_post_form').submit()">Like</a>
                            </div>
                            <form action="{{route('likepost')}}" method="POST" style="display:none;" id="like_post_form">
                                @csrf
                                <input type="number" name="likeOn" value="{{$post->id}}"/>
                            </form>
                            <div class="comment">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
